 ...
 * Test class for testing ExplosiveZombie's methods (other than setters and getters)
 */
...
public class ExplosiveZombieTest extends TestCase {
	...
	protected void setUp() {
		...
		zombie = new ExplosiveZombie(100, spot, board);
	}
	...
	public void testMoveZombieWithNoPlants() {
		int previousSpotId = spot.getSpotId() + 1;
